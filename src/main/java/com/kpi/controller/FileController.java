...
import com.kpi.message.ResponseFile;
import com.kpi.message.ResponseMessage;
import com.kpi.service.FileStorageService;
...
public class FileController {
  ...
  public ResponseEntity<String> getFile(@PathVariable Integer id) {
    ...
    return ResponseEntity.ok()
        ...
        .body(Base64Utils.encodeToString(fileDB.getData()));
  }
}
